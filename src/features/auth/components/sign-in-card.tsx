        ...
        <Card className={'w-full h-full p-8'}>
            ...
            <CardContent className={'space-y-5 px-0 pb-0'}>
                ...
                <div className={'flex flex-col gap-y-2.5'}>
                    <Button disabled={false} onClick={() =>handleProviderSignIn('google')} size='lg' className={'w-full relative'} variant='outline'>
                        <FcGoogle size={25} className={'pr-1'}/> Continue With Google</Button>
                </div>
                <div className={'flex flex-col gap-y-2.5'}>
                    <Button disabled={false} onClick={() => handleProviderSignIn('github')} size='lg' className={'w-full relative'} variant='outline'>
